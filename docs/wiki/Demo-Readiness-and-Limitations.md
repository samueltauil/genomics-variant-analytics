...
| Scheduled landing inventory, completeness, and failure/retry (2.1, 2.2, 2.3) | 32 local tests pass; the same rule runs over a local directory and the Azure Files share; no instrument or SMB transfer was exercised |
