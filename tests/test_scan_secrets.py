...
class ScanSecretsTests(unittest.TestCase):
    ...
    def test_storage_connection_string_is_rejected(self):
        self.write(
            ...
            b"AccountKey=abcd1234ABCD5678efgh9012IJKL3456mnop7890QRST1234"
    ...
    def test_service_bus_shared_access_key_is_rejected(self):
        self.write(
            ...
            b"SharedAccessKey=abcdefghijklmnopqrstuvwxyz1234567890ABCDEFGHIJ=\n",
        )
        self.commit()
        violations = scan_repository(self.repository, base=self.base)
        self.assertEqual(len(violations), 1)
    ...
    def test_sas_query_string_is_rejected(self):
        self.write(
            ...
            b"&sig=abcdefghijklmnop1234567890ABCDEF%3D&se=2026-01-01T00:00:00Z\n",
        )
        self.commit()
        violations = scan_repository(self.repository, base=self.base)
        self.assertEqual(len(violations), 1)
    ...
    def test_private_key_block_is_rejected(self):
        self.write("config/id_rsa", b"-----BEGIN RSA PRIVATE KEY-----\nMIIB\n")
        self.commit()
        violations = scan_repository(self.repository, base=self.base)
        self.assertEqual(len(violations), 1)
    ...
    def test_client_secret_literal_is_rejected(self):
        self.write("config/app.json", b'{"client_secret": "S3cr3tLiteralValue"}\n')
        self.commit()
        violations = scan_repository(self.repository, base=self.base)
        self.assertEqual(len(violations), 1)
    ...
    def test_find_secrets_helper_matches_scan_repository(self):
        ...
        self.assertTrue(find_secrets("AccountKey=abcd1234ABCD5678efgh9012IJKL3456mnop7890=="))
